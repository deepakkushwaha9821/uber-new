...
const Start = () => {
  return (
    <div>
      <div className='bg-cover bg-center bg-[url(https://unsplash.com/photos/a-view-of-a-dashboard-of-a-car-from-inside-a-vehicle-4aLT4gFixyo)] h-screen pt-8 flex justify-between flex-col w-full'>
